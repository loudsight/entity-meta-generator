...
//
// The archived body below is commented out with "// //" rather than "////" on purpose: since
// JEP 467 (Java 23) javac reads a run of lines starting with "///" as a Markdown documentation
// comment, so "////" turned this dead code into five bogus Javadoc comments (Error Prone
// NotJavadoc). Keep the space after the first "//" if you edit these lines.
