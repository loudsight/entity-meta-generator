...
public final class MethodDescriptor {
    ...
    public String toString() {
        return toStringZZ(arguments, codeDescriptor, modifiers, returnType, name);
    }

    public static String toStringZZ(Map<String, String> arguments,
                                    CodeBlockDescriptor codeDescriptor,
                                    List<String> modifiers, String returnType, String name) {
        ...
        if (codeDescriptor.isNotEmpty()) {
            codeBlock.append(codeDescriptor);
        } else {
            codeBlock.append("{}");
        }
